...
import com.ytqf.signal.ringrtc.TurnServerInfoParcel;
...
import static com.ytqf.signal.service.WebRtcCallService.EXTRA_ANSWER_OPAQUE;
import static com.ytqf.signal.service.WebRtcCallService.EXTRA_ANSWER_SDP;
import static com.ytqf.signal.service.WebRtcCallService.EXTRA_AVAILABLE;
import static com.ytqf.signal.service.WebRtcCallService.EXTRA_BROADCAST;
import static com.ytqf.signal.service.WebRtcCallService.EXTRA_CALL_ID;
import static com.ytqf.signal.service.WebRtcCallService.EXTRA_ENABLE;
import static com.ytqf.signal.service.WebRtcCallService.EXTRA_ICE_CANDIDATES;
import static com.ytqf.signal.service.WebRtcCallService.EXTRA_MULTI_RING;
import static com.ytqf.signal.service.WebRtcCallService.EXTRA_OFFER_OPAQUE;
import static com.ytqf.signal.service.WebRtcCallService.EXTRA_OFFER_SDP;
import static com.ytqf.signal.service.WebRtcCallService.EXTRA_OFFER_TYPE;
import static com.ytqf.signal.service.WebRtcCallService.EXTRA_REMOTE_DEVICE;
import static com.ytqf.signal.service.WebRtcCallService.EXTRA_REMOTE_IDENTITY_KEY;
import static com.ytqf.signal.service.WebRtcCallService.EXTRA_REMOTE_PEER_KEY;
import static com.ytqf.signal.service.WebRtcCallService.EXTRA_TURN_SERVER_INFO;
