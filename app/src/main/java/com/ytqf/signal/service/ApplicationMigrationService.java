...
import com.ytqf.signal.database.SmsMigrator;
import com.ytqf.signal.database.SmsMigrator.ProgressDescription;
import com.ytqf.signal.notifications.NotificationChannels;
import com.ytqf.signal.notifications.NotificationIds;
    ...
    implements SmsMigrator.SmsMigrationProgressListener
{
  ...
  public  static final String MIGRATE_DATABASE  = "com.ytqf.signal.ApplicationMigration.MIGRATE_DATABSE";
  public  static final String COMPLETED_ACTION  = "com.ytqf.signal.ApplicationMigrationService.COMPLETED";
