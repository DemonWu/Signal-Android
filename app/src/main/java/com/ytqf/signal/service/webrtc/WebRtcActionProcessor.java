...
import com.ytqf.signal.crypto.IdentityKeyUtil;
...
import com.ytqf.signal.ringrtc.IceCandidateParcel;
import com.ytqf.signal.ringrtc.RemotePeer;
import com.ytqf.signal.service.webrtc.WebRtcData.CallMetadata;
import com.ytqf.signal.service.webrtc.WebRtcData.OfferMetadata;
import com.ytqf.signal.service.webrtc.WebRtcData.ReceivedOfferMetadata;
...
import com.ytqf.signal.util.TelephonyUtil;
...
import static com.ytqf.signal.service.WebRtcCallService.ACTION_ACCEPT_CALL;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_BLUETOOTH_CHANGE;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_CALL_CONCLUDED;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_CALL_CONNECTED;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_CAMERA_SWITCH_COMPLETED;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_CANCEL_PRE_JOIN_CALL;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_DENY_CALL;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_ENDED_CONNECTION_FAILURE;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_ENDED_INTERNAL_FAILURE;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_ENDED_REMOTE_BUSY;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_ENDED_REMOTE_GLARE;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_ENDED_REMOTE_HANGUP;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_ENDED_REMOTE_HANGUP_ACCEPTED;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_ENDED_REMOTE_HANGUP_BUSY;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_ENDED_REMOTE_HANGUP_DECLINED;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_ENDED_REMOTE_HANGUP_NEED_PERMISSION;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_ENDED_SIGNALING_FAILURE;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_ENDED_TIMEOUT;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_FLIP_CAMERA;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_IS_IN_CALL_QUERY;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_LOCAL_HANGUP;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_LOCAL_RINGING;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_MESSAGE_SENT_ERROR;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_MESSAGE_SENT_SUCCESS;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_OUTGOING_CALL;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_PRE_JOIN_CALL;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_RECEIVED_OFFER_EXPIRED;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_RECEIVED_OFFER_WHILE_ACTIVE;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_RECEIVE_ANSWER;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_RECEIVE_BUSY;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_RECEIVE_HANGUP;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_RECEIVE_ICE_CANDIDATES;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_RECEIVE_OFFER;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_REMOTE_RINGING;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_REMOTE_VIDEO_ENABLE;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_SCREEN_OFF;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_SEND_ANSWER;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_SEND_BUSY;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_SEND_HANGUP;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_SEND_ICE_CANDIDATES;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_SEND_OFFER;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_SET_AUDIO_BLUETOOTH;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_SET_AUDIO_SPEAKER;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_SET_ENABLE_VIDEO;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_SET_MUTE_AUDIO;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_START_INCOMING_CALL;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_START_OUTGOING_CALL;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_TURN_SERVER_UPDATE;
import static com.ytqf.signal.service.WebRtcCallService.ACTION_WIRED_HEADSET_CHANGE;
import static com.ytqf.signal.service.WebRtcCallService.EXTRA_ANSWER_WITH_VIDEO;
import static com.ytqf.signal.service.WebRtcCallService.EXTRA_BLUETOOTH;
import static com.ytqf.signal.service.WebRtcCallService.EXTRA_CAMERA_STATE;
import static com.ytqf.signal.service.WebRtcCallService.EXTRA_ERROR;
import static com.ytqf.signal.service.WebRtcCallService.EXTRA_IS_ALWAYS_TURN;
import static com.ytqf.signal.service.WebRtcCallService.EXTRA_MUTE;
import static com.ytqf.signal.service.WebRtcCallService.EXTRA_RESULT_RECEIVER;
import static com.ytqf.signal.service.WebRtcCallService.EXTRA_SPEAKER;
import static com.ytqf.signal.service.webrtc.WebRtcData.AnswerMetadata;
import static com.ytqf.signal.service.webrtc.WebRtcData.HangupMetadata;
import static com.ytqf.signal.service.webrtc.WebRtcData.ReceivedAnswerMetadata;
import static com.ytqf.signal.service.webrtc.WebRtcIntentParser.getAvailable;
import static com.ytqf.signal.service.webrtc.WebRtcIntentParser.getBroadcastFlag;
import static com.ytqf.signal.service.webrtc.WebRtcIntentParser.getCallId;
import static com.ytqf.signal.service.webrtc.WebRtcIntentParser.getEnable;
import static com.ytqf.signal.service.webrtc.WebRtcIntentParser.getIceCandidates;
import static com.ytqf.signal.service.webrtc.WebRtcIntentParser.getIceServers;
import static com.ytqf.signal.service.webrtc.WebRtcIntentParser.getOfferMessageType;
import static com.ytqf.signal.service.webrtc.WebRtcIntentParser.getRemotePeer;
import static com.ytqf.signal.service.webrtc.WebRtcIntentParser.getRemotePeerFromMap;
