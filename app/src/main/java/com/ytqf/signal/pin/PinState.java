...
import com.ytqf.signal.jobmanager.JobTracker;
import com.ytqf.signal.jobs.ClearFallbackKbsEnclaveJob;
...
import com.ytqf.signal.lock.RegistrationLockReminders;
import com.ytqf.signal.lock.v2.PinKeyboardType;
import com.ytqf.signal.logging.Log;
import com.ytqf.signal.megaphone.Megaphones;
import com.ytqf.signal.registration.service.KeyBackupSystemWrongPinException;
...
public final class PinState {
  ...
  /**
   * Should only be called by {@link com.ytqf.signal.migrations.RegistrationPinV2MigrationJob}.
   */
  @WorkerThread
  ...
  /**
   * Should only be called by {@link com.ytqf.signal.jobs.KbsEnclaveMigrationWorkerJob}.
   */
  @WorkerThread
