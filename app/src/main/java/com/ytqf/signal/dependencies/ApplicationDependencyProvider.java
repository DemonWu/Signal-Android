package com.ytqf.signal.dependencies;
...
import com.ytqf.signal.jobmanager.impl.FactoryJobPredicate;
import com.ytqf.signal.jobs.MarkerJob;
...
import com.ytqf.signal.jobs.PushProcessMessageJob;
import com.ytqf.signal.jobs.PushTextSendJob;
import com.ytqf.signal.jobs.ReactionSendJob;
import com.ytqf.signal.jobs.TypingSendJob;
import com.ytqf.signal.messages.IncomingMessageProcessor;
import com.ytqf.signal.crypto.storage.SignalProtocolStoreImpl;
import com.ytqf.signal.database.DatabaseFactory;
import com.ytqf.signal.events.ReminderUpdateEvent;
import com.ytqf.signal.messages.BackgroundMessageRetriever;
import com.ytqf.signal.jobmanager.JobManager;
import com.ytqf.signal.jobmanager.JobMigrator;
import com.ytqf.signal.jobmanager.impl.JsonDataSerializer;
import com.ytqf.signal.jobs.FastJobStorage;
import com.ytqf.signal.jobs.JobManagerFactories;
import com.ytqf.signal.logging.Log;
import com.ytqf.signal.megaphone.MegaphoneRepository;
import com.ytqf.signal.notifications.DefaultMessageNotifier;
import com.ytqf.signal.notifications.MessageNotifier;
import com.ytqf.signal.notifications.OptimizedMessageNotifier;
import com.ytqf.signal.push.SecurityEventListener;
import com.ytqf.signal.push.SignalServiceNetworkAccess;
import com.ytqf.signal.recipients.LiveRecipientCache;
import com.ytqf.signal.messages.IncomingMessageObserver;
import com.ytqf.signal.service.TrimThreadsByDateManager;
import com.ytqf.signal.util.AlarmSleepTimer;
import com.ytqf.signal.util.EarlyMessageCache;
import com.ytqf.signal.util.FeatureFlags;
import com.ytqf.signal.util.FrameRateTracker;
