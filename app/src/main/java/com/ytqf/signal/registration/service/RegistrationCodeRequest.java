...
import com.ytqf.signal.gcm.FcmUtil;
import com.ytqf.signal.logging.Log;
import com.ytqf.signal.push.AccountManagerFactory;
import com.ytqf.signal.registration.PushChallengeRequest;
    ...
    new AsyncTask<Void, Void, VerificationRequestResult>() {
      ...
      VerificationRequestResult doInBackground(Void... voids) {
        try {
          ...
          com.ytqf.signal.logging.Log.w(TAG, "Error during account registration", e);
