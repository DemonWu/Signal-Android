package com.ytqf.signal.stickers;
...
import com.ytqf.signal.components.emoji.MediaKeyboardProvider;
import com.ytqf.signal.database.DatabaseFactory;
import com.ytqf.signal.database.model.StickerPackRecord;
...
import com.ytqf.signal.stickers.StickerKeyboardPageFragment.EventListener;
import com.ytqf.signal.stickers.StickerKeyboardRepository.PackListResult;
import com.ytqf.signal.util.ResUtil;
import com.ytqf.signal.util.ThemeUtil;
import com.ytqf.signal.util.Throttler;
...
/**
 * A provider to select stickers in the {@link com.ytqf.signal.components.emoji.MediaKeyboard}.
 */
