...
import com.ytqf.signal.database.model.databaseprotos.ProfileChangeDetails;
...
import com.ytqf.signal.sms.IncomingGroupUpdateMessage;
...
public class SmsDatabase extends MessageDatabase {
  ...
  public Optional<InsertResult> insertMessageInbox(IncomingTextMessage message, long type) {
    ...
    boolean    unread     = (com.ytqf.signal.util.Util.isDefaultSmsProvider(context) ||
