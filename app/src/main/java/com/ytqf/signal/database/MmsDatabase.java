...
import com.ytqf.signal.attachments.AttachmentId;
import com.ytqf.signal.attachments.DatabaseAttachment;
import com.ytqf.signal.attachments.MmsNotificationAttachment;
import com.ytqf.signal.contactshare.Contact;
import com.ytqf.signal.database.documents.IdentityKeyMismatch;
import com.ytqf.signal.database.documents.IdentityKeyMismatchList;
import com.ytqf.signal.database.documents.NetworkFailure;
import com.ytqf.signal.database.documents.NetworkFailureList;
...
import com.ytqf.signal.database.model.NotificationMmsMessageRecord;
import com.ytqf.signal.database.model.Quote;
import com.ytqf.signal.database.model.ReactionRecord;
import com.ytqf.signal.database.model.SmsMessageRecord;
import com.ytqf.signal.database.model.databaseprotos.BodyRangeList;
...
import com.ytqf.signal.mms.MessageGroupContext;
import com.ytqf.signal.mms.MmsException;
import com.ytqf.signal.mms.OutgoingExpirationUpdateMessage;
import com.ytqf.signal.mms.OutgoingGroupUpdateMessage;
...
import com.ytqf.signal.revealable.ViewOnceExpirationInfo;
...
import com.ytqf.signal.util.CursorUtil;
import com.ytqf.signal.util.JsonUtils;
import com.ytqf.signal.util.SqlUtil;
...
import static com.ytqf.signal.contactshare.Contact.Avatar;
...
public class MmsDatabase extends MessageDatabase {
  ...
  public void markIncomingNotificationReceived(long threadId) {
    ...
    if (com.ytqf.signal.util.Util.isDefaultSmsProvider(context)) {
      DatabaseFactory.getThreadDatabase(context).incrementUnread(threadId, 1);
    }
  ...
  public static class Reader implements MessageDatabase.Reader {
    ...
    private NotificationMmsMessageRecord getNotificationMmsMessageRecord(Cursor cursor) {
      ...
      if (!TextUtils.isEmpty(contentLocation))
        contentLocationBytes = com.ytqf.signal.util.Util.toIsoBytes(contentLocation);

      if (!TextUtils.isEmpty(transactionId))
        transactionIdBytes = com.ytqf.signal.util.Util.toIsoBytes(transactionId);
