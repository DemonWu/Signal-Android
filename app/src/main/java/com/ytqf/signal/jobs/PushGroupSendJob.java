...
import com.ytqf.signal.jobmanager.JobLogger;
...
import com.ytqf.signal.transport.RetryLaterException;
...
public final class PushGroupSendJob extends PushSendJob {
  ...
  public static class Factory implements Job.Factory<PushGroupSendJob> {
    @Override
    public @NonNull PushGroupSendJob create(@NonNull Parameters parameters, @NonNull com.ytqf.signal.jobmanager.Data data) {
