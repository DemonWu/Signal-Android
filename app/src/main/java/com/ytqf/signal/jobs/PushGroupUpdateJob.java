...
import com.ytqf.signal.database.GroupDatabase.GroupRecord;
...
public class PushGroupUpdateJob extends BaseJob {
  ...
  public static final class Factory implements Job.Factory<PushGroupUpdateJob> {
    @Override
    public @NonNull PushGroupUpdateJob create(@NonNull Parameters parameters, @NonNull com.ytqf.signal.jobmanager.Data data) {
