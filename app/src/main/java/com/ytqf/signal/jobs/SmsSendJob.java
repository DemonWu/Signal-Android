...
import com.ytqf.signal.service.SmsDeliveryListener;
...
public class SmsSendJob extends SendJob {
  ...
  public static class Factory implements Job.Factory<SmsSendJob> {
    @Override
    public @NonNull SmsSendJob create(@NonNull Parameters parameters, @NonNull com.ytqf.signal.jobmanager.Data data) {
