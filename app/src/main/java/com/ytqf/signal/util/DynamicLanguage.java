...
import com.ytqf.signal.util.dynamiclanguage.LanguageString;

import java.util.Locale;

/**
 * @deprecated Use a base activity that uses the {@link com.ytqf.signal.util.dynamiclanguage.DynamicLanguageContextWrapper}
 */
@Deprecated
